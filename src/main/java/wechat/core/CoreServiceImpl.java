...
import wechat.core.entity.Info;
import wechat.core.entity.MessageTuLing;
import wechat.core.service.CoreService;
import wechat.message.resp.Article;
import wechat.message.resp.NewsMessage;
import wechat.message.resp.TextMessage;
import wechat.util.HttpClientUtils;
...
//                    respContent=" <a href=\"http://uri.amap.com/marker?position=118.721474,32.034237\">公司安排学习的</a>  ";
            ...
            // 多图文消息---最后一条消息不含图片
                ...
                respContent=HttpClientUtils.get("http://www.tuling123.com/openapi/api?&key=3e2c5281106e4ca3b10d296da39f6d48&info="+content,"utf-8");
